...
# Force the model to run on CPU and use a faster computation type for CPU
...
def translate_tts():
    ...
    audio_url = f"/download/{tts_filename}" 
    return jsonify({"translatedText": translated, "audioUrl": audio_url} )
